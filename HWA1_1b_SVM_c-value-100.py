...
Best result with C = 100. Higher values were not tested.
There are much higher C-values needed to get an acceptable result than at the original Spiral Task.
Interceptions of the two spirals make it very hard for the SVM to classify properly.
...
dataset = pd.read_csv('HWA1_1b_Dataset.csv')
...
plt.title('Classifier Modified Two Spirals Task 1b ( C = 100)')
plt.xlabel('x-axis')
plt.ylabel('y-axis')
plt.legend()
plt.show()
